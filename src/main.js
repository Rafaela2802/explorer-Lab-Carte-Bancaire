...
const adButton = document.querySelector("#add-card")
adButton.addEventListener("click",() => {
  alert("Cartão adicionado/Pessoa Roubada com sucesso")
})
...
cardHolder.addEventListener("input" , () => {
  ...
  ccHolder.innerText = cardHolder.value.length === 0 ? "NOME APELIDO/NOM PRÉNON" : cardHolder.value
})
